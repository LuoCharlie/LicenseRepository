	...
	<div class="container row-style">
	    <div class="row">
	      <div class="col-md-10 text-center col-md-offset-1 col-style" style="background-color: #fff" id="content">
	      	<div class="row title">
	        	<p class="common-title text-align-center"><span>${article.title}</span></p>
                <p class="article-date">
                    <span>整理人: ${article.admin}</span>
                    <span class="glyphicon glyphicon-time" style="padding-left: 30px"></span>&nbsp;${article.date}
                    <span style="padding-left: 30px">浏览次数:&nbsp;${article.click}</span>
                </p>
	        </div>
