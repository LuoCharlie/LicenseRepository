...
<body style="background-color:#FFF">
    ...
    <div class="row col-md-10 text-center col-md-offset-1 col-style  title title-margin-top-50">
        <div class="search_engine-title second-title text-align-center">
            <p><span>搜索结果</span></p>
        </div>
        <table class="table table-striped result-style">
            <caption>兼容许可证</caption>
            <thead>
                <tr>
                    <th align="center">许可证名</th>
                    <th align="center">权利</th>
                    <th align="center">义务</th>
                    <th align="center">禁止</th>
                </tr>
            </thead>
        ...
        <br>    
        <div class="search_engine-title text-align-center">    
            <a href="/opensource/search_engine.jsp">
                <button type="button" id="click_return" class="btn">返回</button>	
            </a>
        </div>
	</div>
	<!--下载栏-->
