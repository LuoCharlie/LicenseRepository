...
<body style="background-color:#f5f5f5">
    ...
    <div class="container row-style ">
        <div class="row" style="font-size: 16px">
            <div class="col-md-10 text-center col-md-offset-1 col-style" style="background-color: #fff" id="content">
                ...
                <textarea id="alter-title" style="width: 100%;padding:0;line-height: 25px" rows="2">${fn:replace(article.title, '<br/>','&#10;')}</textarea>
                <br>
                <br>
                <p class="third-title" style="text-align: left;">摘要：</p>
                <textarea id="alter-introduction" style="width:100%;padding:0;line-height: 25px" rows="2">${fn:replace(article.introduction, '<br/>','&#10;')}</textarea>
                <br>
                <br>
                <p class="third-title" style="text-align: left;">回答：</p>
                <textarea id="alter-content" style="width:100%;padding:0;line-height: 25px" rows="13">${fn:replace(article.content, '<br/>','&#10;')}</textarea>
                <br>
                <br>
                <p class="third-title" style="text-align:center;">
                <button id="article-alter" class="btn button-blue" style="margin:10px 0 20px 0">提交</button> 
                </p>
    ...
    <input type="hidden" name="alter-id" value="${article.id}"/>
