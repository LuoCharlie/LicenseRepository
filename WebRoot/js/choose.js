	...
	$(document).ready(function(){
		...
		$(".search_engine-table").on("click","span",function(){
		 ...
		 $("#click_ok").click(function(){
			 ...
			 $.post("./search_engine",{postData:postData},function(data){
			 ...
			 $.ajax({  
		            ...
		            {  
		            	//window.location.href = './search_engine_result.html'+data;
		                ...
		                for(var i = 0; i < data.length; i++) {
		                  s = "<tr><td><a href='./license_list.html?license_name=" + data[i].name +"'>" + data[i].name + "</a></td><td>" + data[i].rights + "</td><td>" +
		                  data[i].obligations + "</td><td>" + data[i].prohibition + "</td></tr>";
		                  $("#result-table").append(s);
		                }
		            } 
		        });*/
