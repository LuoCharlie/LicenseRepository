...
public class loginFilter implements Filter {
    ...
    public void  doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws java.io.IOException, ServletException {
		...
		if(code.toLowerCase().equals(generatedCode.toLowerCase())) //判断验证码正确
		{
			...
			System.out.println("usertype:"+usertype+";  name:"+name+"\n\n");
			if(isUser(usertype,name,password,location))
			{
...
/*System.out.println("相等，location:"+location);
			...
			request.getRequestDispatcher("license/licenseServlet").forward(request,response);*/
