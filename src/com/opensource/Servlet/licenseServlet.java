...
public class licenseServlet extends HttpServlet
{
	...
	public void searchEngine(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        //String data[] = request.getParameterValues("postData[]");
        String dataRights = request.getParameter("rights");
        dataRights = new String (dataRights.getBytes("iso8859-1"),"UTF-8");//解决乱码
        String dataObligations = request.getParameter("obligations");
        dataObligations = new String (dataObligations.getBytes("iso8859-1"),"UTF-8");//解决乱码
        String dataProhibition = request.getParameter("prohibition");
        dataProhibition = new String (dataProhibition.getBytes("iso8859-1"),"UTF-8");//解决乱码 
        ...
        //Collections.sort(prohibition);
        System.out.println("prohibition:"+prohibition);
		System.out.println("getList : ");
		List<featureLicense> license = featureDao.getList();
		request.setAttribute("license", license);
		request.getRequestDispatcher("/search_engine_result.jsp").forward(request, response);
	}
